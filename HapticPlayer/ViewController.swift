...
class ViewController: UIViewController {
    override func viewDidAppear(_ animated: Bool) {
        ...
        let clips = [
            ...
            HapticClip(
                title: "Explosion FX",
                subtitle: "Strong Impact",
                videoURL: .remoteURL(URL(string: "https://example.com/video/explosion.m3u8")!),
                haptic: .remoteURL(URL(string: "https://example.com/haptics/explosion.ahap")!),
                thumbSystemImage: "flame.fill"
            ),
            HapticClip(
                title: "Sci-Fi Pulse",
                subtitle: "Rhythmic Pattern",
                videoURL: .bundled(name: "SampleVideo2"),
                haptic: .bundled(name: "pulse"),
                thumbSystemImage: "antenna.radiowaves.left.and.right"
            )
        ]
